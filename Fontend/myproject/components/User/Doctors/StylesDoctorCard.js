...
export default StyleSheet.create({
    ...
    seeAll: { fontSize: 13, color: '#2196F3', fontWeight: '500' },
    listContainer: {paddingHorizontal: 16, marginTop: 15, gap: 10, paddingBottom: 8 },
    ...
    degree: { fontSize: 12, color: '#888' },
    name: { fontSize: 14, fontWeight: '700', color: '#1a1a2e', marginBottom: 8 },
